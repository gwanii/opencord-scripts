...
class RepoManifest():
    ...
    def __init__(self):
        ...
        remotes = {remote.attrib['name']: remote.attrib['review'] for remote in self.manifest_xml.findall('remote')}
        self.remote = remotes[default.attrib['remote']]
        ...
        for project in self.manifest_xml.iter('project'):
            ...
            project_remotes[repo_name] = project.attrib.setdefault('remote', default.attrib['remote'])
        ...
        for repo_name, repo_path in project_repos.iteritems():
            self.repos[repo_name] = RepoRepo(repo_name, repo_path, remotes[project_remotes[repo_name]])
